...
Процедура ПриОткрытии(Отказ)
	...
	МассивНастройки = СтрРазделить(ПолучитьМакет("Настройки").ПолучитьТекст(), Символы.ПС);
	
	УстановитьЗаголовокСистемы(МассивНастройки[0]);
	ПоказыватьРазличияВМодальномРежиме = Булево(Число(МассивНастройки[1]));
...
Процедура Сравнить(Команда = Неопределено)
	...
	Если ПоказыватьРазличияВМодальномРежиме Тогда
